...
function TestimonialCard(props: TestimonialCardProps) {
  ...
  return (
    ...
    >
      ...
      />
      <Blur position={'absolute'} top={-30} left={100} style={{ filter: 'blur(70px)' }} />
    </Flex>
  )
}
export const Testimonials: React.FC = () => {
  return (
    <Flex textAlign={'center'} p={10} justifyContent={'center'} direction={'column'} width={'full'} overflow={'hidden'}>
      <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
        <chakra.h3 fontWeight={'bold'} fontSize={20} textTransform={'uppercase'} color={'purple.400'}>
          People love us
        </chakra.h3>
        ...
        <chakra.h2 margin={'auto'} width={'70%'} fontWeight={'medium'} color={useColorModeValue('gray.500', 'gray.400')}>
          ...
          use EEZY to manage their social media content!
        </chakra.h2>
      </Box>
