...
import { Box, Heading, Container, Text, Button, Stack, Icon, useColorModeValue, createIcon, Center } from '@chakra-ui/react'
    ...
    <>
      ...
      <Container id="about-us" maxW={'3xl'}>
        <Stack as={Box} textAlign={'center'} spacing={{ base: 8, md: 14 }} py={{ base: 10, md: 18 }}>
          <Center>
            <Image src="/lis-logo.jpg" width={300} height={300} alt="lis-logo" />
          </Center>
